        ...
        @auth
          ...
          <div class="hidden md:block relative group">
            ...
            <div class="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
              ...
              <a href="{{ route('two-factor.settings') }}" class="flex items-center gap-3 px-4 sm:px-5 py-2.5 sm:py-3 text-gray-700 hover:bg-pink-50 transition-colors text-sm sm:text-base font-medium">
